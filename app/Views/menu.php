                ...
                <div class="container">
                    <form action="<?= base_url(menu()['controller']); ?>/add" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input placeholder="Tabel" type="text" name="tabel" class="form-control form-control-sm" required>
                        </div>

                        <div class="mb-3">
                            <label style="font-size: 12px;">Controller</label>
                            <input placeholder="Controller" type="text" name="controller" class="form-control form-control-sm" required>
                        </div>

                        <div class="mb-3">
                            <label style="font-size: 12px;">Icon</label>
                            <input placeholder="Icon" type="text" name="icon" class="form-control form-control-sm" required>
                        </div>

                        <div class="mb-3">
                            <label style="font-size: 12px;">Grup</label>
                            <input placeholder="Grup" type="text" name="grup" class="form-control form-control-sm">
                        </div>
